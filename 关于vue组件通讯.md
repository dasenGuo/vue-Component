...
对于字面量语法和动态语法，初学者在父组件模板中向子组件中传递数据时加和不加 v-bind 有什么区别，同时会引起什么错误等问题会感觉迷惑。
...
### `$bus`使用中常见的两个问题
![$bus](https://raw.githubusercontent.com/Michelle111111/makedown-images/master/img/bus%E6%BC%94%E7%A4%BA.gif?token=AkxR02aSCy4FGkcSk_PocdmL3UIpMETLks5cR81pwA%3D%3D)
